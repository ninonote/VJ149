...
public class LoudnessObject : MonoBehaviour {
	
	private AudioSource audio;
	AudioReceiver audioreceiver;
	GameObject loudnessobj;
	...
	void Update () {
		...
		var loudness = sensitivity*audioreceiver.volume*100;
		//cube.transform.localScale = new Vector3 (loudness, loudness, loudness);

		//loudnessobj.transform.Rotate(Vector3.up * Time.deltaTime*20, Space.World);
